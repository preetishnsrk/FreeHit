...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public PastMatchesListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View contactView = inflater.inflate(R.layout.item_past_match_list, parent, false);

        // Return a new holder instance
        PastMatchesListAdapter.ViewHolder viewHolder = new PastMatchesListAdapter.ViewHolder(contactView);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(PastMatchesListAdapter.ViewHolder viewHolder, int position) {
        ...
        PastMatchCardItem pastMatchCard = mPastMatchCards.get(position);
